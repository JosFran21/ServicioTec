...
$datos = dbConnection::RAW("SELECT marca, modelo, FechaCompra, FechaInicioG, FechaFinG, users.nombre FROM `inventario` inner join users where users.id = inventario.id_usuario");
                        ...
                        <div class="panel panel-default"aria-multiselectable="true">
                            ...
                            <div class="panel-body">
                                ...
                                <?php foreach($datos as $p): ?>
                                        ...
                                        <td><div><?php echo $p['FechaCompra']; ?></div></td>
                                        <td><?php echo $p['FechaInicioG'];?></td>
                                        <td><?php echo $p['FechaFinG'];?></td>
