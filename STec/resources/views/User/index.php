            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="/dashboard"><i class="fa fa-circle fa-fw"></i> Inicio</a>
                        </li>
                        <li>
                            <a href="/medicine"><i class="fa fa-ticket fa-fw"></i> Tickets</a>
                        </li>
                        <li>
                            <a href="/medicine"><i class="fa fa-book fa-fw"></i> Knowledge</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
                    ...
                    <form>
                        <div class="panel panel-default"aria-multiselectable="true">
                            ...
                            <div class="panel-heading">
                                <span><h2>Usuario: <?php echo logData::getData('nombre') . "    " . logData::getData('apellido');  ?></h2></span>
                            <div>
                                <h2>Bienvenido tu número de tickets son: 6</h2>
                            </div>
