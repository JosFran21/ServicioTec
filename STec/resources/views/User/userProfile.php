                ...
                <div class="col-lg-12">
                        <div class="panel panel-default"aria-multiselectable="true">
                            ...
                            <div class="panel-heading">
                                <span><h2>Información personal: </h2></span>
                            </div>
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped  table-hover" id="dataTables-example">
                                    <tr><td>
                                        ...
                                        <div class="form-group">
                                            <input class="form-control" type="genero" placeholder="Area Trabajo" id="ATrabajo" name="ATrabajo" style="height: 30px; width: 100%;" value="<?php echo logData::getData('areaTrabajo'); ?>" disabled/>
                                        </div>
                                        </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <label>Trabajo:</label>
                                        <div class="form-group">
                                            <input class="form-control" type="text" placeholder="Trabajo" id="Trabajo" name="Trabajo" style="height: 30px; width: 100%;" value="<?php echo logData::getData('trabajo'); ?>"disabled/>
                                        </div>
                                       </td>
                                        </tr>
                                    </table>
